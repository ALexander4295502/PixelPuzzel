...
func compareColorDifferenceByGreyScale(colorA: UIColor, colorB: UIColor) -> Float {
    let denominator = Float(256.0)
    return abs(colorA.greyScale - colorB.greyScale) / denominator
}
